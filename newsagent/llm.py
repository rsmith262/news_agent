...
class LLM:
    ...
    def draft_news_post(
        ...
        prompt = (
            ...
            "Aim for roughly 220 to 320 characters before any URL is added.\n"
            "Prefer one sharp point over a full recap.\n"
    ...
    def draft_analysis_post(self, policy_text: str, user_request: str) -> str:
        prompt = (
            ...
            "Aim for roughly 220 to 320 characters.\n"
            "Make one sharp point, not a mini article.\n"
            "Do not use em dashes. Use commas, colons, or full stops instead.\n"
    ...
    def draft_explainer_post(self, policy_text: str, user_request: str) -> str:
        prompt = (
            ...
            "Aim for roughly 220 to 320 characters.\n"
            "Keep it tight and avoid over-explaining.\n"
            "Do not use em dashes. Use commas, colons, or full stops instead.\n"
    ...
    def revise_post(
        ...
        prompt = (
            ...
            "Unless the user asks otherwise, aim for roughly 220 to 320 characters.\n"
